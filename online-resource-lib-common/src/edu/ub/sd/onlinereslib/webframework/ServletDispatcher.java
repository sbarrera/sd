package edu.ub.sd.onlinereslib.webframework;

import edu.ub.sd.onlinereslib.webframework.annotations.*;
import edu.ub.sd.onlinereslib.webframework.exceptions.RequiredHttpRequestParameter;
...
public class ServletDispatcher extends HttpServlet {
    ...
    public void init() {
        ...
        log("Loaded application services");
    ...
    private void registerUnknownRouteHandler() {
    ...
    private void connectServiceDependencies(Class clazz) throws Exception {
        ...
        if ( clazz.isAnnotationPresent(Service.class) ) {
            ...
            ServiceController controller = (ServiceController) servletServiceProviders.get(clazz);
